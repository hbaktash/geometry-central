...
// clang-format off
// preserve ordering
#include "geometrycentral/volume/halfedge_logic_templates.ipp"
#include "geometrycentral/volume/halfedge_element_types.ipp"
#include "geometrycentral/volume/surface_mesh.ipp"
// clang-format on
